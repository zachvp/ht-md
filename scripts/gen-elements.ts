...
writeFileSync(resolve(root, 'src/options-elements.ts'), `// AUTO-GENERATED by scripts/gen-elements.ts
export const els = {
${elLines.join('\n')}
}
`)
...
const filename = 'scripts/gen-elements.ts'
writeFileSync(resolve(root, 'src/lib/settings.ts'), `// AUTO-GENERATED by ${filename}
...
`)
console.log(`wrote src/lib/settings.ts (${storageEntries.length} keys)`)
